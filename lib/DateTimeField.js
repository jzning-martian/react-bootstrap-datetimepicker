    ...
    value: function render() {
      return _react2["default"].createElement(
        ...
        _react2["default"].createElement(
          ...
          _react2["default"].createElement("input", _extends({ ref: "dtpbutton", type: "text", onClick: this.onClick, onBlur: this.onBlur, placeholder: this.props.placeholder, className: "form-control", onChange: this.onChange, value: this.state.inputValue }, this.props.inputProps))
        )
      );
    }
  }], [{
